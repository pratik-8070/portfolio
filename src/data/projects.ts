...
export const projects: Project[] = [
  {
    ...
    links: {
      github: 'https://github.com/pratik-8070/Automation-exercise',
  ...
  },
  {
    ...
    tagline: 'Android automation with Appium and WebdriverIO. Runs on a schedule and reports itself.',
    visual: 'mobile',
    tags: ['Appium', 'WebdriverIO', 'Android', 'Mocha'],
    problem:
      'Mobile regression by hand is slow and repetitive, and nobody runs it at 2am. The app still needs checking whenever it changes.',
    built: [
      'Native Android framework with Appium + WebdriverIO',
      'Android automation via UiAutomator2 on the Android Emulator',
      'Locator discovery with Appium Inspector',
      'Reusable locators and assertions',
      'Mocha test structure',
      'Scheduled execution',
      'Automated reports',
    ],
    technologies: ['Appium', 'WebdriverIO', 'TypeScript', 'JavaScript', 'Android', 'UiAutomator2', 'Appium Inspector', 'Android Emulator', 'Mocha'],
    approach: [
      'Stable locators identified and verified in Appium Inspector',
      'Mocha suites organised by feature',
      'Scheduled runs with reports generated automatically',
    ],
    result: 'Unattended, scheduled Android test runs with reports waiting at the end.',
